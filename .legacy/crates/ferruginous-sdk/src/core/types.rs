...
pub enum Object {
    ...
    Stream(Arc<BTreeMap<Vec<u8>, Object>>, bytes::Bytes),
...
impl Object {
    ...
    #[must_use] pub fn new_name(data: Vec<u8>) -> Self {
        Self::Name(bytes::Bytes::from(data))
    }

    /// Creates a new string object.
    #[must_use] pub fn new_string(data: Vec<u8>) -> Self {
        Self::String(bytes::Bytes::from(data))
    }
    ...
    #[must_use] pub fn new_stream(dict: BTreeMap<Vec<u8>, Object>, data: Vec<u8>) -> Self {
        Self::Stream(Arc::new(dict), bytes::Bytes::from(data))
    }
    ...
    /// Creates a new stream object from existing data.
    #[must_use] pub fn new_stream_bytes(dict: Arc<BTreeMap<Vec<u8>, Object>>, data: bytes::Bytes) -> Self {
